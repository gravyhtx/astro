...
const UploadFile = ( data, success, instructions, instructionsClasses, containerClasses, inputClasses, labelClasses, fileNameClasses ) => {
  ...
  return (
    <>
    {instructions ? <>instructions</> : instructionsClasses ? <div className={instructionsClasses}>{instructions}</div> : <></>}
    <div className={"upload-file-container container center "+containerClasses}>
