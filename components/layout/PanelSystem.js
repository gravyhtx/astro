...
const PanelSystem = ( children, bkgColor, bkgImgUrl, colSize, fullsize, fullWidth, fullHeight, classes, containerClasses, styles, key )  => {
  ...
  return (
    <div className={"panel-container"+panelContainerClasses} key={key?key:0} >
